...
class TestCli(unittest.TestCase):
    ...
    def test_main_help(self) -> None:
        ...
        self.assertIn("BIS Scraper - Download and process central bank speeches", result.output)
    ...
    def test_scrape_command(self, mock_scrape_bis) -> None:
        ...
        mock_scrape_bis.return_value = ScrapingResult(
            downloaded=5, skipped=2, failed=1
        )
