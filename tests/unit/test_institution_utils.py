...
class TestInstitutionUtils:
    ...
    def test_standardize_institution_name(self) -> None:
        ...
        assert standardize_institution_name("European Central Bank") == "european central bank"
        ...
        assert standardize_institution_name("Board of the US Federal Reserve System") == "board of governors of the federal reserve system"
    ...
    def test_get_institution_from_metadata(self) -> None:
        ...
        metadata = "Speech by Mr. John Smith, Governor of the ECB, at the Annual Conference"
        assert get_institution_from_metadata(metadata) == "european central bank"
