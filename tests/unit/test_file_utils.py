...
class TestFileUtils(unittest.TestCase):
    ...
    def test_normalize_institution_name(self) -> None:
        ...
        self.assertEqual(normalize_institution_name("European Central Bank"), "european_central_bank")
        
        # Test with special characters
        self.assertEqual(normalize_institution_name("Bank's & Money"), "banks_and_money")
        
        # Test with commas
        self.assertEqual(normalize_institution_name("Finance, Economics"), "finance_economics")
    ...
    def test_format_filename(self) -> None:
        ...
        # Test with 'r' prefix
        self.assertEqual(format_filename("r220101a", "European Central Bank"), "220101a.pdf")
        
        # Test without 'r' prefix
        self.assertEqual(format_filename("220102b", "European Central Bank"), "220102b.pdf")
